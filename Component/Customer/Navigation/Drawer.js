  ...
  return (
    <Animated.View style={[{flex:1,overflow:'hidden'},style]}>
      <Stack.Navigator
        ...
        <Stack.Screen name="My Account" component={Notification}></Stack.Screen>
        <Stack.Screen name="Payment" component={Notification}></Stack.Screen>
        <Stack.Screen name="Notification" component={Notification}></Stack.Screen>
        <Stack.Screen name="Raise Questions" component={Notification}></Stack.Screen>
        <Stack.Screen name="FAQs" component={Notification}></Stack.Screen>
